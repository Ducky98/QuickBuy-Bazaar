...
import { products } from "../Product/ProductCards/Productdata";
import ProductCards from "../Product/ProductCards/ProductCards";
import { filters, singleFilters } from "../Product/ProductCards/filterdata";
import {
  FormControl,
  FormControlLabel,
  FormLabel,
                ...
                {singleFilters.map((section) => (
                  ...
                  >
                    {({ open }) => (
                      <div>
                        {" "}
                        {/* Replace empty fragment with a div */}
                        <h3 className="-my-3 flow-root">
                          <Disclosure.Button className="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                            <FormLabel
                            ...
                            <FormControl>
                              ...
                              >
                                {section.options.map((option, optionIdx) => (
                                  <FormControlLabel
                                    onChange={(e) =>
                                      handleSingleFilterChange(e, section.id)
                                    }
                                    key={`filter-${section.id}-${optionIdx}`}
                                    id={`filter-${section.id}-${optionIdx}`}
                                    className=""
