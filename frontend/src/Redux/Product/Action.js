...
export const findProducts = (reqData) => async (dispatch) => {
    ...
    try {
        const {data} = api.get(`api/products/size=${sizes}&minPrice=${minPrice}&maxPrice=${maxPrice}&minDiscount=${minDiscount}&catgory=${category}&stock=${stock}&sort=${sort}&pageNumber=${pageNumber}&pageSize=${pageSize}`);
